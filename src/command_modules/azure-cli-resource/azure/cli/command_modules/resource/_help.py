...
helps['rest'] = """
    ...
    examples:
       ...
       - name: Update a Azure Active Directory Graph User's display name
         text: >
             az rest --method patch --headers "{\"Content-Type\": \"application/json\"}" --url "https://graph.microsoft.com/v1.0/users/johndoe@azuresdkteam.onmicrosoft.com" --payload "{\"displayName\":\"jondoe2\"}"
"""
